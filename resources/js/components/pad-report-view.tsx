...
export function PadReportView({
  ...
  return (
    ...
    >
        ...
        @media print {
          * {
          ...
          .print-container {
            ...
            padding: 37mm 10mm 5mm 10mm !important;
            margin: 0 !important;
      ...
      >
        {/* Main Report Container - No Header & Footer for Pad Report */}
        <div
          ref={containerRef}
        ...
        >
          <div style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", width: "100%" }}>
            <div>
              ...
              <div style={{ fontSize: "19px", fontWeight: "bold", textAlign: "center", marginTop: "5px", marginBottom: "8px", color: "#000000" }}>
                Medical Report
              </div>

              {/* Patient Details Meta Table + Image */}
              <div style={{ display: "flex", gap: "4px", width: "100%", marginBottom: "6px", alignItems: "stretch" }}>
                <div style={{ flex: 1 }}>
            ...
            <div style={{ borderTop: "2px solid #16a34a", marginTop: "6px", marginBottom: "4px", paddingTop: "0px", textAlign: "center" }}>
              <p className="font-bengali" style={{ color: "#000000", fontWeight: "bold", fontSize: "13px", marginTop: "4px", marginBottom: "4px" }}>
